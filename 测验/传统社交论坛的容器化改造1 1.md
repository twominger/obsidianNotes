...
/root/.local/bin/repo2module -s stable ${packagedir} modules.yaml  
modifyrepo_c --mdtype=modules modules.yaml ${packagedir}/repodata/
...
for dir in "$repodir"/*/; do
  ...
  # echo "baseurl = file://$dir" >> "$repo_file"  # 使用 file:// 来表示本地路径
   echo "baseurl = http://192.168.200.10$dir" >> "$repo_file"  # 使用 file:// 来表示本地路径
